  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl prose prose-brand">
      ...
      <ul>
        ...
        <li><strong>Advertising (Google AdSense):</strong> To display advertisements. Third party vendors, including Google, use cookies to serve ads based on a user's prior visits to your website or other websites.</li>
      </ul>
