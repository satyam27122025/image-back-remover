...
// .wrangler/tmp/bundle-M6Iiwb/checked-fetch.js
  ...
  async fetch(request, env, ctx) {
    ...
    if (request.method === "POST" && url.pathname === "/api/remove-background") {
      try {
        ...
        providerData.append("image_file", image);
